      ...
      begin
        unless @stats[user.id].nil? || @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP'].empty?
          ...
          ::PvpKillsWeapon.create({
            user: user,
            super: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsSuper']['basic']['value'],
            granade: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsGrenade']['basic']['value'],
            melee: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsMelee']['basic']['value'],
            ...
            shotgun: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsShotgun']['basic']['value'],
            sniper: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsSniper']['basic']['value'],
            side_arm: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsSideArm']['basic']['value'],
            sword: @stats[user.id]['Response']['mergedAllCharacters']['results']['allPvP']['allTime']['weaponKillsSword']['basic']['value'],
          })
        end
      rescue
